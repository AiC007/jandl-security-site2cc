...
**Status:** REPLACEMENT DRAFT. Send draft `r-1711275914861988734` and delete draft `r-7634859591922967276`. The first draft named a sender address (enquiries@theaiconsultancy.ai) that has no mailbox behind it; the operator caught it before sending. Sender corrected in code to ai@theaiconsultancy.ai (commit `5c65014`), redeployed, second live test 12:34 BST accepted (HTTP 200, reference `quote_1789126480956_vj6sgyi97`). First live test 12:21 BST (`quote_1789125715497_x26khtnhn`) went out from the wrong address and was delivered; the email tells Jag to ignore both tests. Fix originally merged as `98887be` (PR #22).
