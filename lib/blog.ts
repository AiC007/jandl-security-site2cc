...
<p>For a free survey covering fire alarm specification, <a href="/services/fire-risk-assessments">fire risk assessment</a>, or service contract takeover, <a href="/contact">contact us</a> or call <a href="tel:02045385925">0204 538 5925</a> or 0208 220 4770. We cover all of Essex and Greater London. For more on fire alarms see our <a href="/services/fire-alarms">fire alarm services</a> page or read our <a href="/blog/hmo-fire-alarm-requirements-bs5839">HMO fire alarm requirements guide</a>.</p>
`,
    faqs: [
      {
...
`,
    faqs: [
      {
        question: 'Do landlords legally need a fire risk assessment?',
        answer: 'Where a let building has communal areas, or is an HMO, the responsible person, usually the landlord or managing agent, must have a fire risk assessment under the Regulatory Reform (Fire Safety) Order 2005. A single property let to one household sits outside the Order for the home itself, but other duties such as working smoke alarms still apply, and insurers often expect an assessment.',
      },
      {
        question: 'How often should a landlord review the fire risk assessment?',
        answer: 'Keep it current and review it at least annually, and sooner if the building, its use, or its occupants change. An assessment that has never been revisited is unlikely to be accepted as suitable and sufficient.',
      },
      {
        question: 'Is the fire risk assessment the same as the fire alarm certificate?',
        answer: 'No. The assessment decides what level of fire detection the building needs. The alarm system is then installed and certified to meet that level. They are separate documents and you need both.',
      },
      {
    ...
    faqs: [
      {
        ...
        answer: 'Usually it is the building’s communal fire risk assessment that the buyer’s solicitor or lender wants to see, and that is the responsibility of the freeholder or management company, not the individual seller. It is best treated as a common transaction requirement rather than a personal legal duty.',
      },
      {
        question: 'What is the difference between an EWS1 form and a fire risk assessment?',
        answer: 'A fire risk assessment is a life-safety review of the building required under the Fire Safety Order. An EWS1 form is a separate lender document about the external wall system for valuation. One does not replace the other, and a building may need both.',
      },
      {
        question: 'Who pays for the fire risk assessment when selling a flat?',
        answer: 'The cost normally falls to the responsible person for the communal areas, the freeholder or management company, often through the service charge. Sellers sometimes fund one to keep a sale moving, but that is a commercial choice.',
      },
      {
        question: 'How quickly can an assessment be arranged?',
        answer: 'It depends on the building and access, but arranging the assessment and any remedial work through a single provider is usually the fastest route. Contact J&L Security to discuss timescales for your building.',
      },
    ],
  },
  {
...
`,
    faqs: [
      {
        question: 'Is a fire risk assessment a legal requirement for businesses?',
        answer: 'Yes. The Regulatory Reform (Fire Safety) Order 2005 requires the responsible person for non-domestic premises to have a suitable and sufficient fire risk assessment. Since 1 October 2023 it must be recorded in writing whatever the size of the business.',
      },
      {
        question: 'Does a small business with fewer than five staff need a written assessment?',
        answer: 'Yes. Section 156 of the Building Safety Act 2022 removed the old five-employee threshold. All businesses must now record the assessment in full.',
      },
      {
        question: 'How often should a business fire risk assessment be reviewed?',
        answer: 'Keep it current and review it at least annually, and sooner if the premises, the work carried out, or the people using the building change.',
      },
      {
...
`,
    faqs: [
      {
        question: 'What are remedial works after a fire risk assessment?',
        answer: 'They are the actions the assessment recommends to reduce fire risk: typically fire alarm upgrades, emergency lighting, electrical testing, and fire door repairs or replacement. The action plan lists them, usually in priority order.',
      },
      {
        question: 'Do I have to complete every action immediately?',
        answer: 'Urgent, high-priority actions should be addressed promptly. Lower-priority items can be scheduled, but you should have a documented plan with target dates and keep the certificates as you go.',
      },
      {
        question: 'What records should I keep?',
        answer: 'Keep the assessment and its action plan, plus commissioning and test certificates for alarm and emergency lighting work, electrical certificates, and records of any fire door works. Together these prove the risk is being managed.',
      },
      {
